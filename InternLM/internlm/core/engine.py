...
class Engine:
    ...
    def step(self, spike=False):
        ...
        success, grad_norm = self.optimizer.step(spike=spike)
...
class Engine_motion(Engine):
    def __init__(
        ...
        self._motion_criterion = motion_criterion
    ...
    @property
    def motion_criterion(self):
        """Returns the model attached to the engine."""
        return self._motion_criterion
