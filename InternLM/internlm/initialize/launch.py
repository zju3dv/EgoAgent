...
def get_default_parser():
    ...
    parser.add_argument("--num_workers", type=int, default=8, help="number of workers for the train data loader.")
    parser.add_argument("--eval_iters", type=int, default=100, help="number of iterations for evaluation.")
    parser.add_argument("--eval_ckpt", type=str, default='model', help="evaluation checkpoint.")
    parser.add_argument("--knn_t", type=float, default=0.07)
    parser.add_argument("--eval_idx", type=int, default=0)
    parser.add_argument("--lp_lr", default=0.001, type=float,)
    parser.add_argument("--lp_weight_decay", default=1e-6, type=float,)
    parser.add_argument("--lp_batch_size_per_gpu", default=128, type=int,)
    parser.add_argument("--lp_epochs", default=100, type=float,)
    parser.add_argument("--lp_output_dir", default="./", help='Path to save logs and checkpoints')
    parser.add_argument("--lp_early_stop", default=0, type=int,)
    parser.add_argument('--lp_save_freq', default=10, type=int, )
    parser.add_argument('--lp_eval_freq', default=1, type=int, )
    return parser
